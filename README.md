...
To build the final jar and optimize the AbsaDtFundsransferAsyncFinal application for production, run:
...
Then navigate to [http://localhost:9076](http://localhost:9076) in your browser.
